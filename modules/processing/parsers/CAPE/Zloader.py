...
rule Zloader
{
    ...
    strings:
        ...
        $decrypt_conf_1 = {48 8d [5] [0-6] e8 [4] 48 [3] 48 [3] 48 [6] E8}
        $decrypt_key_1 = {E8 [3] 00 4? 8B 45 ?? 4? 89 45 ?? 4? 8D 0D [3] 00 E8 [3] 00 4? 8B 45 ?? 66 89 C2 4? 8D 0D [3] 00 4? B? FC 03 00 00 E8 [4] 4? 83 C4}
    condition:
