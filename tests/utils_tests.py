...
class TestConvertChar:
    def test_utf(self):
        assert_equal("\\xe9", utils.convert_char("\xe9"))

    def test_digit(self):
        assert_equal("9", utils.convert_char("9"))
...
class TestConvertToPrintable:
    def test_utf(self):
        assert_equal("\\xe9", utils.convert_to_printable("\xe9"))

    def test_digit(self):
        assert_equal("9", utils.convert_to_printable("9"))
