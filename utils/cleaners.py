...
def delete_data(tid):
    ...
    if db.delete_task(tid):
        ...
        log.info("failed to remove task %s from DB" % (tid))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs=2,
        metavar=("STARTING_TASK", "ENDING_TASK"),
        type=int,
        required=False,
    )
    ...
    parser.add_argument("-ddm", "--dont-delete-mongo", help="Keep mongo data but remove the rest", required=False, default=False,
                        action="store_true")
