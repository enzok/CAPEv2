...
table = [
    ...
    (
        ...
        "process",
        ("uupllpp", "ApplicationName", "CommandLine", "CreationFlags", "ProcessId", "ThreadId", "ProcessHandle", "ThreadHandle",),
    ),
    ...
    (
        ...
        "process",
        ("pPPpP", "ProcessHandle", "BaseAddress", "NumberOfBytesProtected", "NewAccessProtection", "OldAccessProtection",),
    ),
    ...
    (
        "RtlCreateUserThread",
        "threading",
        ("plppPl", "ProcessHandle", "CreateSuspended", "StartAddress", "StartParameter", "ThreadHandle", "ThreadIdentifier",),
    ),
    ...
    (
        "ZwCreateProcessEx",
        "process",
        ("ssssss", "ProcessHandle", "PID", "DesiredAccess", "InheritHandles", "InheritFromProcessHandle", "SectionHandle",),
    ),
