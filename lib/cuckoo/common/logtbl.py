...
table = [
    ...
    (
        "NtCreateFile",
        "filesystem",
        ("PpOll", "FileHandle", "DesiredAccess", "FileName", "CreateDisposition", "ShareAccess"),
    ),
    ...
    (
        ...
        "synchronization",
        ("PpOl", "NamedPipeHandle", "DesiredAccess", "PipeName", "ShareAccess"),
    ),
    ...
    (
        "CreateRemoteThread",
        "threading",
        ("3plL", "ProcessHandle", "StartRoutine", "Parameter", "CreationFlags", "ThreadId"),
    ),
    (
        "RtlCreateUserThread",
        "threading",
    ...
    (
        ...
        "process",
        ("sssss", "ProcessHandle", "PID", "BaseAddress", "Buffer", "NumberOfBytesToWrite"),
    ),
    ...
    (
        "NtMapViewOfSection",
        "process",
        ("sssss", "ProcessHandle", "PID", "BaseAddress", "SectionHandle", "Win32Protect"),
    ),
    ...
    (
        ...
        "filesystem",
        ("ssss", "FileHandle", "OriginalName", "Renamed", "FileInformationClass"),
    ),
