rule DarkGate
{
    meta:
        ...
        cape_options = "bp0=$config+40,action0=dump:edx::1025,count=0,typestring=Darkgate Config"
    ...
    strings:
        ...
        $config = {B9 01 04 00 00 E8 [4] 8D 45 ?? 8B 55 ?? E8 [4] 8D 4D ?? B? [4] 8B 45 ?? E8 [4] 8B 55}
    condition:
        ($alphabet) and (any of ($part*) or $config)
}
