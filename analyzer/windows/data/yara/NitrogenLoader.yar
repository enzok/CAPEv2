...
rule NitrogenLoaderConfig
{
    meta:
        ...
        cape_options = "bp0=$decrypt1*+6,hc0=1,count=0,action0=string:rcx,bp1=$decrypt4*+1,hc1=1,action1=string:rdx,typestring=NitrogenLoader Config"
    strings:
        ...
        $decrypt3 = {48 63 44 24 ?? 33 D2 48 F7 B4 24 [4] 48 8B C2 48 8B 8C 24 [4] 0F BE 04 01 89 84 24}
        $decrypt4 = {8B 8C 24 [4] 2B C8 8B C1 48 63 4C 24 ?? 48 8B 94 24 [4] 88 04 0A}
